...
<template>
   <main>
    <div class="config_buttons">
      <button :class="store.config == 'cityDistStreet' ? 'active' : ''" @click="store.changeConfig('cityDistStreet')">Город-район-улица</button>
      <button :class="store.config == 'coutryCityDistStrHouse' ? 'active' : ''" @click="store.changeConfig('coutryCityDistStrHouse')">Страна-город-район-улица-дом</button>
      <button :class="store.config == 'cityStreet' ? 'active' : ''" @click="store.changeConfig('cityStreet')">Город-улица</button>
    </div>
    <div class="content">
      <TreeView :tree="trees" />
